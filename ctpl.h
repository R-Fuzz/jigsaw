...
#define _ctplThreadPoolLength_  2000000
#endif
...
namespace ctpl {
    ...
    public:
        ...
        thread_pool(int nThreads, int pin_core_start, int queueSize = 2000000) : core_start_(pin_core_start), q(queueSize) { this->init(); this->resize(nThreads); }
